SELECT * FROM customer_shopping_behaviour.customer;
...
select item_purchased,round(avg(review_rating),2) as Avg_Product_Rating from customer
...
delete from customer where customer_id between 39001 and 39010; 
