...
This Project focused on analyzing customer shopping behaviour of a retail company using data analytics and converting the entire analysis into a live interactive web application.
